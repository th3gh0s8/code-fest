...
$Query="INSERT INTO products(product_name,product_description,by_price,sell_price,avl_qty,is_active,product_profile_image,product_category) Values"
        . "('".$productName."','".$productDescription."','".$buyPrice."','".$sellPrice."','".$qty."','".$status."','".$target_file."','".$category."')";
