...
$Query="INSERT INTO products(product_name,product_description,by_price,sell_price,avl_qty,product_category,is_active,product_profile_image) Values"
...
if ($result===TRUE){
    ...
    header("Location:../index.php?msg=product saved failed".mysqli_error($conn));    die();
}
?>